...
class Linea:
    ...
    - Un guión en la segunda posición para marcar como eliminada/comentario.
    ...
    def texto(self):
        ...
        Además, elimina las anotaciones sobre rima interna.
        """
    ...
    def silabas(self):
        ...
        Aquí no se utiliza la cantidad como dígito, dado el padding, dado que
